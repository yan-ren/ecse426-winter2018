...
/**
	* @brief Read the button pressed on the keypad
	* @param None
	* @retval None
	*/
char readKeypad(void) {
	...
	if(keyLock){
//		printf("in keylock\n");
		/* check if a button is pressed and in which col the button is */
		if (HAL_GPIO_ReadPin(GPIOC, col1) == GPIO_PIN_RESET){
//			printf("col 1 detected\n");
			debounce++;
...
/**
	* @brief Read the button pressed on the keypad without debouncing 
	* @param None
	* @retval None
	*/
